...
//                     
//                     // 본문 필터링 - "블로그 타이틀" 관련 텍스트 제거
//                     if (content) {
//                         // 1. "블로그 타이틀" 텍스트 모두 제거
//                         content = content.replace(/블로그\s*타이틀/gi, '').trim();
//                         
//                         // 2. 본문에서 제목 제거 (제목이 본문에 포함된 경우)
...
//                         if (blogName) {
//                             // 블로그명이 앞부분에 있으면 제거
//                             if (content.startsWith(blogName)) {
//                                 content = content.substring(blogName.length).trim();
//                             }
//                             // 블로그명이 중간에 있어도 제거
//                             content = content.replace(blogName, '').trim();
//                         }
//                         
//                         // 4. 앞부분의 불필요한 구분자 및 공백 제거
